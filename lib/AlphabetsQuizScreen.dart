...
class AlphabetsQuizScreen extends StatefulWidget {
  @override
  _AlphabetsQuizScreen createState() => _AlphabetsQuizScreen();
}

class _AlphabetsQuizScreen extends State<AlphabetsQuizScreen> {
  int currentQuestion = 1;
  final int totalQuestions = 5;

  List<String> correctAnswers = ['A', 'D', 'C', 'I', 'B'];
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image.asset(
                    "assets/images/image$currentQuestion.png",
                    height: 120,
                  ),
                ],
              ),
              ...
              children: List.generate(3, (index) {
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      "Letter ${options[currentQuestion - 1][index]}",
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              happy
                  ? "You're becoming a sign language pro!"
            ...
            ElevatedButton(
               onPressed: () {
                Navigator.push(
                  context,
                  happy
                 ? MaterialPageRoute(builder: (context) => AlphabetsScreen(text: '',))
